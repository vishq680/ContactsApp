...
class ContactsTableViewCell: UITableViewCell {
    ...
    func setupEditButton() {
        ...
        wrapperCellView.addSubview(editButton)
    }
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            editButton.centerYAnchor.constraint(equalTo: wrapperCellView.centerYAnchor),
            editButton.trailingAnchor.constraint(equalTo: wrapperCellView.trailingAnchor, constant: -10),
